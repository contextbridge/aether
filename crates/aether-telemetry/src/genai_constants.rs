...
pub const GEN_AI_SYSTEM_INSTRUCTIONS: &str = attribute::GEN_AI_SYSTEM_INSTRUCTIONS;
...
pub const AETHER_INPUT_MESSAGES_SHA256: &str = "aether.llm.input_messages.sha256";
pub const AETHER_SYSTEM_INSTRUCTIONS_SHA256: &str = "aether.llm.system_instructions.sha256";
