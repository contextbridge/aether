...
- **Rust tests** — `#[tokio::test]`s in `crates/internal-evals/tests` using the `aether-evals` harness directly. Best for evals maintained in this repo. See [Running evals](#running-evals).
