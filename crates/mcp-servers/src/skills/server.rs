...
use rmcp::{
    ...
    model::{
        ...
        PaginatedRequestParams, Prompt, PromptArgument, PromptMessage, Role, ServerCapabilities, ServerInfo,
    },
...
impl ServerHandler for SkillsMcp {
    ...
    async fn get_prompt(
        ...
        Ok(GetPromptResult::new(messages).with_description(spec.description.clone()).into())
    }
}
