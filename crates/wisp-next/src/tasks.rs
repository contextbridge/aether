...
use crate::attachments::{AttachmentOutcome, PromptAttachment, build_attachments};
        ...
        match self {
            ...
            Self::ResolveWorkspace { cwd } => {
                ...
                .unwrap_or_else(|_| TaskResult::WorkspaceResolved {
                    status: WorkspaceStatus::new(crate::workspace_status::home_relative_path(&fallback_cwd), None),
                    cwd: fallback_cwd,
                })
            }
        }
