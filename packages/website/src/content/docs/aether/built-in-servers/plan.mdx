...
Without a submit command, `submit_plan` uses MCP elicitation and the client displays a plan review UI. Aether's terminal UI renders it as a dedicated [plan review screen](/aether/terminal/plan-review/); other ACP clients show their own form.
...
| `content`  | `string` | Markdown plan body. Must not be empty.                                    |
