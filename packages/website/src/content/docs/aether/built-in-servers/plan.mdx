...
| ---------- | -------- | ------------------------------------------------------------------------ |
| `planName` | `string` | Stable plan identifier: letters, numbers, dashes, and underscores only; non-empty, and must not start or end with a dash or underscore. |
| `content`  | `string` | Markdown plan body. Must be non-empty.                                                  |
