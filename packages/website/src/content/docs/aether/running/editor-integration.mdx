...
Aether can run as an [Agent Client Protocol v2](https://agentclientprotocol.com/protocol/v2/migration) server. Editors that speak draft ACP v2 can start `aether acp`, create sessions, select Aether agents, stream tool progress, and handle MCP elicitation such as artifact review forms.
