...
Discover and invoke MCP tools from the shell. This is how agents — and you — call deferred (proxied) tools directly:
...
See [Tools](/aether/settings/mcp-servers/#merging-and-deferred-tool-behavior) for the `--json`, stdin, and `--timeout` details.
