...
| `session_usage`              | Per-call token usage and estimated cost, plus session totals.  |
...
See [Getting Started](/getting-started/overview/) and [Settings](/aether/settings/overview/#how-do-i-define-an-agent) for project scaffolding details.
