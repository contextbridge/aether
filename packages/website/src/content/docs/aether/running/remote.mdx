...
- There are no heartbeats, reconnect retries, configurable deadlines, or resume journals. A silently half-open connection may hold the client slot until the transport observes failure.
