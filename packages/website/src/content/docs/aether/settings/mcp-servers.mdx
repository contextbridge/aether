...
Invoke tools with exactly one JSON object supplied through `--json` or stdin. Because this is a real subprocess, it composes with ordinary Bash pipelines, redirects, `&&`, command substitution, and scripts:
