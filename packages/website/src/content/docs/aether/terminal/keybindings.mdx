...
The file picker and pasted-path attachments are unavailable in [remote sessions](/aether/running/remote/) — files are indexed locally, and remote workspaces live on the server.
