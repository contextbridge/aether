...
| Tool | Description |
|------|-------------|
| `list_skills` | List all available skills with metadata for discovery |
...
<Tabs>
  ...
  <TabItem label="Writing a skill">
    ...
    Additional markdown files in the skill directory can be loaded on demand via `get_skills`. When a client loads `SKILL.md`, the response also includes a manifest of available auxiliary files.
  </TabItem>
</Tabs>
