...
Codex authenticates through a browser-based OAuth flow with OpenAI. In the TUI, select a Codex model and use the provider login flow; credentials are stored securely in your OS keychain.
