...
| `lsp`       | Standalone language-aware symbol lookup, diagnostics, workspace search, and rename | No args in Aether's built-in registration; it uses the project root.                                                  |
...
<CardGrid>
  ...
  <LinkCard
    title="LSP"
    description="Language-aware symbol lookup, diagnostics, rename"
    href="/aether/built-in-servers/lsp/"
  />
  <LinkCard
