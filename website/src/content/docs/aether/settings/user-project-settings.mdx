  ...
  "agents": [
    {
      ...
      "userInvocable": true,
      "prompts": ["planner/SYSTEM.md", "mcp.json"]
    }
  ]
}
```
  ...
  "agents": [
    {
      ...
      "prompts": [
        ...
        {
          "type": "glob",
          "pattern": "${WORKSPACE}/.aether/rules/*.md",
          "optional": true
        }
      ],
      "mcps": [
...
This agent loads its system prompt and MCP config from the user's Aether home, then optionally adds project-level instructions and MCP servers when they exist.
